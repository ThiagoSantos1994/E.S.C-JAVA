...
WHERE
    ...
    AND a.id_Consolidacao = :idConsolidacao
    AND a.tp_DespesaConsolidacao = 'N'
GROUP BY
    (CASE WHEN a.ds_NomeDespesa = '*EMP' THEN emp.ds_TituloEmprestimo  ELSE a.ds_NomeDespesa END),a.vl_Limite, a.id_Despesa, a.id_DetalheDespesa, a.id_Funcionario, a.tp_Emprestimo,a.tp_EmprestimoAPagar, a.id_Emprestimo,a.id_Consolidacao,a.tp_Poupanca,a.tp_Anotacao,a.ds_NomeDespesa,a.tp_DebitoAutomatico,a.id_OrdemExibicao,a.tp_LinhaSeparacao,a.tp_DespesaReversa,a.tp_PoupancaNegativa,a.tp_Relatorio,a.tp_ReferenciaSaldoMesAnterior,a.tp_DespesaCompartilhada, a.tp_DebitoCartao, a.tp_DespesaConsolidacao
ORDER BY
