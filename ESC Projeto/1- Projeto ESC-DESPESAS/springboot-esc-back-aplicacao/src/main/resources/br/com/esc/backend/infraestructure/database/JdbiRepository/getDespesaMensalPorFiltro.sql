...
GROUP BY
    (CASE WHEN a.ds_NomeDespesa = '*EMP' THEN emp.ds_TituloEmprestimo  ELSE a.ds_NomeDespesa END),a.id_Despesa, a.id_Funcionario, a.vl_Limite, a.id_DetalheDespesa,a.tp_Emprestimo,a.id_Emprestimo,a.tp_Poupanca,a.tp_Anotacao,a.ds_NomeDespesa,a.tp_DebitoAutomatico,a.id_OrdemExibicao,a.tp_LinhaSeparacao,a.tp_DespesaReversa,a.tp_PoupancaNegativa,a.tp_Relatorio,a.tp_ReferenciaSaldoMesAnterior,a.tp_DespesaCompartilhada,a.tp_Reprocessar, a.tp_Meta, a.tp_DebitoCartao, a.tp_EmprestimoAPagar, a.tp_VisualizacaoTemp
ORDER BY
